...
const FALLBACK_VELOCITY: { day: string; commits: number; prs: number; reviews: number }[] = [
  ...
  { day: 'Sat', commits: 14, prs: 5, reviews: 8 },
  { day: 'Sun', commits: 9, prs: 2, reviews: 6 },
  { day: 'Tomorrow (LSTM)', commits: 124, prs: 45, reviews: 68 },
];
...
const TEAM_PROFILES: Record<string, {
  ...
  'All': {
    ...
    predictedCommits: 124, predictedPRs: 45, predictedReviews: 68,
  },
  'Team Lead': {
    ...
    velocity: [
      ...
      { day: 'Sat', commits: 2, prs: 1, reviews: 1 },
      { day: 'Sun', commits: 1, prs: 0, reviews: 1 },
      { day: 'Tomorrow (LSTM)', commits: 16, prs: 6, reviews: 10 },
    ],
    predictedCommits: 16, predictedPRs: 6, predictedReviews: 10,
  },
  'Code Committer': {
    ...
    velocity: [
      ...
      { day: 'Sat', commits: 1, prs: 0, reviews: 0 },
      { day: 'Sun', commits: 0, prs: 0, reviews: 0 },
      { day: 'Tomorrow (LSTM)', commits: 11, prs: 3, reviews: 4 },
    ],
    predictedCommits: 11, predictedPRs: 3, predictedReviews: 4,
  },
  'PR Reviewer': {
    ...
    velocity: [
      ...
      { day: 'Sat', commits: 0, prs: 0, reviews: 2 },
      { day: 'Sun', commits: 0, prs: 0, reviews: 1 },
      { day: 'Tomorrow (LSTM)', commits: 5, prs: 3, reviews: 12 },
    ],
    predictedCommits: 5, predictedPRs: 3, predictedReviews: 12,
  },
  'Issue Tracker': {
    ...
    velocity: [
      ...
      { day: 'Sat', commits: 0, prs: 0, reviews: 0 },
      { day: 'Sun', commits: 0, prs: 0, reviews: 0 },
      { day: 'Tomorrow (LSTM)', commits: 3, prs: 2, reviews: 4 },
    ],
    predictedCommits: 3, predictedPRs: 2, predictedReviews: 4,
  },
  'Silent Stalker': {
